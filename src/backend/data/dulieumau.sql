...
-- ==========================================
INSERT INTO CHAMCONG (ma_nv, ngay_lam, gio_vao, gio_ra, so_gio, trang_thai) VALUES
('PDAT0001', '2024-09-02', '08:00:00', '17:00:00', 8, 'Đúng giờ'),
('PDAT0001', '2024-09-03', '08:15:00', '17:30:00', 8.25, 'Muộn'),

('PKTT0001', '2024-09-02', '08:10:00', '17:20:00', 8.17, 'Đúng giờ'),
('PKTT0001', '2024-09-03', '08:30:00', '18:00:00', 9.5, 'Muộn'),

('PITN0001', '2024-09-02', '08:05:00', '17:00:00', 7.92, 'Đúng giờ'),
('PITN0001', '2024-09-04', '08:45:00', '17:30:00', 8.75, 'Muộn'),

('PKDN0001', '2024-09-02', '08:00:00', '17:00:00', 8, 'Đúng giờ'),
('PKDN0001', '2024-09-05', '08:25:00', '17:10:00', 8.75, 'Muộn');
...
-- ==========================================
INSERT INTO CHAMCONG (ma_nv, ngay_lam, gio_vao, gio_ra, so_gio, trang_thai) VALUES
('PDAT0001', '2024-10-01', '08:00:00', '17:00:00', 8, 'Đúng giờ'),
('PDAT0001', '2024-10-04', '08:10:00', '17:30:00', 8.33, 'Đúng giờ'),

('PKTT0001', '2024-10-02', '08:20:00', '17:50:00', 8.5, 'Muộn'),
('PKTT0001', '2024-10-03', '08:00:00', '17:05:00', 8.08, 'Đúng giờ'),

('PITN0002', '2024-10-01', '08:00:00', '16:40:00', 8.66, 'Đúng giờ'),
('PITN0002', '2024-10-05', '08:30:00', '17:30:00', 9, 'Muộn'),

('PKDN0002', '2024-10-03', '08:05:00', '17:00:00', 7.92, 'Đúng giờ'),
('PKDN0002', '2024-10-07', '08:45:00', '17:30:00', 8.75, 'Muộn');
...
-- ==========================================
INSERT INTO CHAMCONG (ma_nv, ngay_lam, gio_vao, gio_ra, so_gio, trang_thai) VALUES
('PDAT0001', '2024-11-01', '08:00:00', '17:00:00', 8, 'Đúng giờ'),
('PDAT0001', '2024-11-06', '08:22:00', '17:40:00', 8.3, 'Muộn'),

('PKTT0001', '2024-11-03', '08:15:00', '17:15:00', 8, 'Đúng giờ'),
('PKTT0001', '2024-11-08', '08:35:00', '17:50:00', 8.25, 'Muộn'),

('PITN0001', '2024-11-02', '08:05:00', '17:00:00', 7.92, 'Đúng giờ'),
('PITN0001', '2024-11-09', '08:45:00', '17:30:00', 8.75, 'Muộn'),

('PKDN0001', '2024-11-02', '08:00:00', '17:00:00', 8, 'Đúng giờ'),
('PKDN0001', '2024-11-10', '08:25:00', '17:20:00', 8.91, 'Muộn');
...
-- ==========================================
INSERT INTO CHAMCONG (ma_nv, ngay_lam, gio_vao, gio_ra, so_gio, trang_thai) VALUES
('PDAT0001', '2024-12-02', '08:00:00', '17:00:00', 8, 'Đúng giờ'),
('PDAT0001', '2024-12-05', '08:12:00', '17:25:00', 8.21, 'Muộn'),

('PKTT0001', '2024-12-01', '08:10:00', '17:20:00', 8.17, 'Đúng giờ'),
('PKTT0001', '2024-12-06', '08:40:00', '17:40:00', 8.66, 'Muộn'),

('PITN0002', '2024-12-03', '08:00:00', '16:50:00', 8.83, 'Đúng giờ'),
('PITN0002', '2024-12-08', '08:20:00', '17:40:00', 9.33, 'Muộn'),

('PKDN0003', '2024-12-03', '08:05:00', '17:00:00', 7.92, 'Đúng giờ'),
('PKDN0003', '2024-12-09', '08:50:00', '17:30:00', 8.66, 'Muộn');
